...
pub const MAX_MEM_USE: usize = 4_000_000_000;



pub fn readsimple() -> std::io::Result<()> {
...
pub fn sort_and_write_to_file(v: &mut Vec<f64>, tmp_file_names: &mut Vec<String>) {
...
pub fn create_large_file(size: usize, filename: &str) {
